	...
	<body>
		<header>
			...
			<div class="container">
				<div class="row">
					<nav>
						<ul class="nav nav-default navbar-static-top nav-justified">
							<li role="presentation" class="active"><a href="#">Sarah Ruth Finkel</a></li>
							<li role="presentation"><a href="#">Portfolio & Contact</a></li>
						</ul>
					</nav>
				</div>
			</div>
					...
					<div class="col-md-3">
						<p>
							<em>"There is a vitality, a life force, an energy, a quickening that is translated through you into
								...
								not have it." –Martha Graham, dancer and choreographer.</em>
						</p>
					</div>
				</div>
			</div>
